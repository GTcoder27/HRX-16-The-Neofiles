        ...
        <div className="bg-slate-800/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-slate-700/50 p-8 w-full max-w-md ">
          ...
          <div className="space-y-4 mb-6">
            <div className="relative group">
              <input
                ...
                className="w-full px-4 py-4 rounded-xl bg-slate-700/70 backdrop-blur-sm text-white border border-slate-600/50 focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:border-transparent placeholder-slate-400 transition-all duration-300 group-hover:bg-slate-700/90"
              />
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full py-4 rounded-xl bg-white text-gray-700 font-semibold hover:bg-gray-50 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-white/25 relative overflow-hidden group flex items-center justify-center space-x-3"
            >
              {/* Google Logo SVG */}
