    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white relative overflow-y-hidden w-[100%]">
      ...
      <div className="relative z-10">
        ...
        <div className="w-full flex justify-center mt-8">
          <button
            onClick={() => navigate('/ai')}
            className="px-6 py-3 bg-indigo-600 text-white rounded-xl font-semibold shadow-md hover:bg-indigo-700 hover:shadow-lg hover:scale-105 focus:outline-none transform transition duration-300"
          >
